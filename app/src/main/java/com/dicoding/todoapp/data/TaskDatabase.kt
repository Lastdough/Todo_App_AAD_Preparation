...
abstract class TaskDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        fun getInstance(context: Context, applicationScope: CoroutineScope): TaskDatabase {
                    ...
                    override fun onCreate(db: SupportSQLiteDatabase) {
                        ...
                        INSTANCE?.let { taskDatabase ->
                            applicationScope.launch {
                                val taskDao : TaskDao = taskDatabase.taskDao()
                                fillWithStartingData(context.applicationContext, taskDao)
                            }
                        }
                    }
                }).build()
